...
//              if($item->id ==4){  print_r($allcats);die;}
               $arr2 = array();
        ...
        try {
            ...
            if ($request != false) {
                ...
                $subitems = Product::model()->itemsListing($catId, $productcatId, $start, $end);
                  ...
                  $allitems = Product::model()->itemsListingFeatured($catId, $productcatId, $start, $end, 1);
                $count = count($allitems);
                $response['count'] = intval($count);
                $subitems = Product::model()->itemsListingFeatured($catId, $productcatId, $start, $end);
                
                if($allitems == null){
                 
                $allitems = Product::model()->itemsListingFavorite($catId, $productcatId, $start, $end, 1);
                $count = count($allitems);
                $response['count'] = intval($count);
                $subitems = Product::model()->itemsListingFavorite($catId, $productcatId, $start, $end);
                }
                if($allitems == null){
                   // echo 'gg0';die;
                $allitems = Product::model()->itemsListingall($catId, $productcatId, $start, $end, 1);
                $count = count($allitems);
                $response['count'] = intval($count);
                $subitems = Product::model()->itemsListingall($catId, $productcatId, $start, $end);
                }
                }
                $item_arr = array();
...
//                print_r($request);die;
                ...
                if (count($proitem) > 0) {
                    ...
                    $item['desc'] = $this->stringVal($proitem->description);
                ...
                if (count($model) == 1) {
                    ...
                    if ($authuser === true) {
                        ...
                        foreach ($subfavs as $fav) {
                            ...
                            $arr3['price'] = doubleval($fav->price);
            ...
            if ($request != false) {
                ...
                if (count($model) == 0) {
                    ...
                    foreach ($colors as $color) {
                        ...
                        $arr4['title'] = $this->stringVal($color['color']);
                        $colors_arr[] = $arr4;
                    }
                    ...
                    if ($authuser === true) {
                        if ($subitems) {
                            foreach ($subitems as $item) {
                                ...
                                $arr3['price'] = doubleval($item->price);
                ...
                if (count($user) == 1) {
                    ...
                    if ($authuser === true) {
                        ...
                        if ($id2 == 0) {
                            ...
                            $model = ShippingValue::model()->findByPk($id2);
                        }
                        //$model = new ShippingValue;
                        $model->title = $value;
