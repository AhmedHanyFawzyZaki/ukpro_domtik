...
<span class="menu-title pull-left col-sm-6">
    <?php if($product->flag != 1 ){ ?>  
    <label class="main_item_price pull-left"><?= Helper::limit_words($product->title, 6);?></label>
    <?php }else{
        ?>
    <label class="main_item_price pull-left"><a href="<?php echo $product->url ?>" target="_blank" ><?= $product->title;?></a></label>
    <?php
    } ?>
<label class="main_item_price pull-right"><?= $product->price;?> GBP</label>
                    ...
                    if ($product->quantity > 0) {
                        ...
                        <div class='form-group'>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label item_specs_lbl">Price</label>
                                    <div class="col-sm-7" style="padding: 5px 0;">
                                        
                                        <label style="color: #EE3E2B;"><?php echo $product->price; ?> </label>
                                        GBP
                                    </div>
                                </div>
