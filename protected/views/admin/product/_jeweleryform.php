...
<div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                echo $form->dropDownList($model, 'product_category_id', CHtml::listData(ProductCategory::model()->findAll(array('condition'=>'category_id=4')), 'id', 'title'), array(
...
<p style="color:red">please upload Main Image  with 220 width, 220 height</p>
<div class='control-group'>
