...
<div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                echo $form->dropDownList($model, 'product_category_id', CHtml::listData(ProductCategory::model()->findAll(array('condition'=>'category_id=9')), 'id', 'title'), array(
...
<div style="display:block" id="dpt">
        <div class="control-group">
            ...
            <div class="controls"  id="cat">
                <?php
                        if (empty($model->product_category_id))                    echo 
...
<p><?php  echo $form->dropDownListRow($model, 'type',array("0"=>"product","1"=>"service"),array('id' => 'protype'));?></p>
...
<div style="display:<?= $display2?>" id="countrycity">
...
<div style="display:<?= $display1?>" id="quantity">
...
<p style="color:red">please upload Main Image  with 350 width, 250 hight</p>
<div class='control-group'>
...
<p><?php  echo $form->dropDownListRow($model, 'on_sale',array("1"=>"on sale","0"=>" not on sale "),array('id' => 'sale'));?></p>
...
<script>
    $("#stock").change(function() {
       //  alert($(this).val());
        if ($(this).val() == 1)
        {
            $("#quantity0ld").css('display', 'block');
        }
        if($(this).val() == 0)
        {
           // alert($(this).val());
            $("#quantityold").css('display', 'none');
        }
