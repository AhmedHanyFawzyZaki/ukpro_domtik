...
<div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                echo $form->dropDownList($model, 'product_category_id', CHtml::listData(ProductCategory::model()->findAll(array('condition'=>'category_id=6')), 'id', 'title'), array(
...
<p><?php echo $form->dropDownListRow($productdetails, 'decor_style_id', CHtml::listData(DecorStyle::model()->findAll(), 'id', 'title'), array('prompt' => 'select Style ', 'class' => 'listtxt')); ?></p>


<p><?php echo $form->dropDownListRow($productdetails, 'decor_type_id', CHtml::listData(DecorType::model()->findAll(), 'id', 'title'), array('prompt' => 'select Type ', 'class' => 'listtxt')); ?></p>
...
<p style="color:red">please upload Main Image  with 400 width, 250 height</p>
<div class='control-group'>
...
?>
<div class="control-group ">
    <label class="control-label"><?= Yii::t('translate', 'Product Colors') ?> </label>
    <div class="controls">
        <?php
        $this->widget('Select2', array(
            'model' => $model_col,
            'attribute' => 'colors_id',
            'data' => Helper::getColors($model->id),
...
<div class="control-group ">
    <label class="control-label"><?= Yii::t('translate', 'Product Sizes') ?> </label>
    <div class="controls">
        <?php
        $this->widget('Select2', array(
            'model' => $model_siz,
...
<?php echo $form->textAreaRow($productdetails, 'dimensions', array('class' => 'span5')); ?>
