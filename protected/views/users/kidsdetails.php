...
<div class="form-group ">
    ...
    <div class="form-group">
        <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="inputPassword3">Kids Type:</label>
        <div class="col-md-6 col-sm-8 col-xs-12">
<p><?php  echo $form->dropDownListRow($productdetails, 'kids_type',array("0"=>"Baby","1"=>"kids","2"=>"moms and maternity"),array('prompt'=>'select Kids Age ','class' => 'form-control'));?></p>

        </div>
      </div>
    
    <div class="form-group">
        <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="inputPassword3">Kids  For:</label>
        <div class="col-md-6 col-sm-8 col-xs-12">
<p><?php  echo $form->dropDownListRow($productdetails, 'kids_for',array("0"=>"Fashion ","1"=>"Entertainment ","2"=>"Nursery and Gear"),array('prompt'=>'select Kids For ','class' => 'form-control'));?></p>
    ...
    <div  class="col-md-6 col-sm-8 col-xs-12">
    <?php echo $form->textFieldRow($model, 'old_price', array('rows' => 6, 'cols' => 50, 'class' => 'form-control','append' => 'GBP')); ?>
