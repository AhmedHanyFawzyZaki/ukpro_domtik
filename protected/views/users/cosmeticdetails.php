...
<script src="<?php echo Yii::app()->baseUrl;?>/js/general/jquery.js"></script>
<script src="<?php echo Yii::app()->baseUrl;?>/js/general/bootstrap.js"></script>
...
?>
    ...
    <div  style="width:600px;min-height:5px;margin-left: 220px;clear: both"></div>
      ...
      <div class="form-group">
                ...
                <div class="col-md-6 col-sm-8 col-xs-12">
                    ...
                    if ($model->isNewRecord != '1' and ! empty($sizes)) {
                      ...
                      $sizees=Sizes::model()->findAllByAttributes(array('category_id'=>3));
                            ...
                            ?>
                           <select class="form-control" name="product[size][]" placeholder="size">
                ...
                <input type="text" name="product[price][]" value="<?php echo $size->price; ?>" class='form-control'/><br/>
                <input type="text" name="product[quantity][]" value="<?php echo $size->quantity; ?>" class='form-control'/><br/>
 ...
 <?php
                    ...
                    <div class="col-sm-6-size ">
                        ...
                        <input type="text" name="product[quantity][]"  class='form-control' placeholder="quantity"/>                   
                    </div>
<br/><br/>                
    <?php
                    $this->widget('ext.reCopy.ReCopyWidget', array(
                        'targetClass' => 'col-sm-6-size',
                        'addButtonLabel' => 'Add New Size',
                        'addButtonCssClass' => 'add-more',
                        'removeButtonLabel' => 'Remove This Size',
                     //   'removeButtonCssClass' => 'add-more',
                        'addButtonId' => 'sizes',
                    ));
                    ?>	
...
<p><?php echo $form->dropDownList($productdetails, 'brand_id', CHtml::listData(Brand::model()->findAll("category_id=$model->category_id"), 'id', 'title'), array('prompt' => 'select brand', 'class' => 'form-control','required'=>'required')); ?></p>
        ...
        <?php echo $form->labelEx($productdetails,'gender',array('class'=>'col-md-3 col-sm-4 col-xs-12 control-label')); ?>
    <div class="col-md-6 col-sm-8 col-xs-12">
