...
<div class="row items">
    ...
    <form method="post" name="zanox_form" action="<?php echo Yii::app()->getBaseUrl(true) . "/users/saveZanox" ?>" >
...
//            print_r($item);die;
           ...
           <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="col-md-12 col-sm-12 col-xs-12 amazon item-box">
                    <input type="checkbox" name="check[]"  value="<?php echo $item->ean ?>"/>
                    <input type="hidden" name="asin[]" value="<?php echo $item->id ?>"/>
                    <div class="col-md-12 col-sm-12 col-xs-12 item-img amazon-img">
                        <a target="_blank" class="prod-img" href=""><img alt="Product 2" src="<?php echo $image ?>"></a>
...
<?php // $fields = $item['fields'] ?>
                    <div class="item-info amazon-info">
                        <span class="item-name"><a target="_blank" href="<?php echo $item->trackingLinks ?>"><?php echo $item->name ?></a></span>
<!--                        <span class="item-categ"><a href="/projects/2014/domtik/realstate">REAL STATE</a></span>-->
                        <span class="item-price"><?php echo $item->price .' '.$item->currency ?></span>
                    </div>
