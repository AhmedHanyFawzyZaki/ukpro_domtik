...
?>
  ...
  <div class="form-group">
        ...
        <div class="col-md-6 col-sm-8 col-xs-12">
<p><?php echo $form->dropDownListRow($productdetails, 'decor_style_id', CHtml::listData(DecorStyle::model()->findAll(), 'id', 'title'), array('prompt' => 'select Style ', 'class' => 'form-control')); ?></p>
  ...
  <div class="form-group">
        <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="inputPassword3">Product category:</label>
        <div class="col-md-6 col-sm-8 col-xs-12">
<p><?php echo $form->dropDownListRow($productdetails, 'decor_type_id', CHtml::listData(DecorType::model()->findAll(), 'id', 'title'), array('prompt' => 'select Type ', 'class' => 'form-control')); ?></p>
     ...
     <div class="form-group">
        <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="inputEmail3"> Dimensions :</label>
        <div class="col-md-6 col-sm-8 col-xs-12">
         <?php echo $form->textField($productdetails, 'dimensions', array('class' => 'form-control')); ?>
...
<div class="form-group ">
            <label class="col-md-3 col-sm-4 col-xs-12 control-label"><?=Yii::t('translate', 'Product Colors')?> </label>
            <div class="col-md-6 col-sm-8 col-xs-12">
                <?php
            ...
            <div class="form-group ">
            <label class="col-md-3 col-sm-4 col-xs-12 control-label"><?=Yii::t('translate', 'Product Sizes')?> </label>
            <div class="col-md-6 col-sm-8 col-xs-12">
                <?php
                $this->widget('Select2', array(
                    'model' => $model_siz,
