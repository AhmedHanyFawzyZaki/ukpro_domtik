...
<div class="row profile">
    ...
    <div class="col-md-9 col-sm-8 col-xs-12">
        ...
        if (Yii::app()->user->hasFlash('success')) {
            ...
            <?php
        } elseif (Yii::app()->user->hasFlash('updated-success')) {
            ?>
            <div class="alert alert-success">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <?php echo Yii::app()->user->getFlash('updated-success'); ?>.
            </div>
        <?php } elseif (Yii::app()->user->hasFlash('add-error')) {
            ?>
        ...
        <div class="info seller-profile">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-5 col-xs-12 control-label" for="inputEmail3">Mian Category:</label>
                <div class="col-md-6 col-sm-8 col-xs-12">
                    <input id="Product_title" class="form-control" type="text" readonly="readonly" value="<?php echo $model->category->title ?>">
                </div>
            </div>
    ...
    <?php //echo $form->error($productdetails, 'sub_category_id');  ?>
            ...
            <p style="color:red">please upload Main Image  with 200 width , 230 height </p>
<div class='form-group'>
    ...
    <div class='col-md-6 col-sm-8 col-xs-12'>
        ...
        ?>
            ...
            <div class="form-group" style="display:<?php echo $display ?>" id="sales">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="on_sale">Old Price :</label>
                <div  class="col-md-6 col-sm-8 col-xs-12">
                    <?php echo $form->textField($model, 'old_price', array('rows' => 6, 'cols' => 50, 'class' => 'form-control')); ?>
            ...
            <div  style="width:600px;min-height:5px;margin-left: 220px;clear: both"></div>
...
<div class="form-group ">
            ...
            <div class="form-group ">
            <label class="col-md-3 col-sm-4 col-xs-12 control-label">Product Sizes</label>
            <div class="col-md-6 col-sm-8 col-xs-12">
                <?php
                $this->widget('Select2', array(
                    'model' => $model_siz,
                    'attribute' => 'sizes_id',
                    'data' => Helper::getSizes(1),
                    'htmlOptions' => array('class' => "col-md-12", 'multiple' => 'multiple'),
                ));
                ?>
            </div>
...
<p><?php echo $form->dropDownList($productdetails, 'brand_id', CHtml::listData(Brand::model()->findAll("category_id=$model->category_id"), 'id', 'title'), array('prompt' => 'select brand', 'class' => 'form-control','required'=>'required')); ?></p>
  ...
  <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="on_sale">Gender:</label>
                <div class="col-md-6 col-sm-8 col-xs-12">
                   
        <?php echo $form->radioButtonList($productdetails,'gender',array('0'=>'men','1'=>'women') ,array("class"=>"form-control")); ?>
