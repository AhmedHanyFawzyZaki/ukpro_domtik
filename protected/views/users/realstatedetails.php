...
<div class="form-group">
        <?php echo $form->labelEx($productdetails,'real_estate_type',array('class'=>'col-md-3 col-sm-4 col-xs-12 control-label')); ?>
    <div class="col-md-6 col-sm-8 col-xs-12">
            <?php echo $form->radioButtonList($productdetails,'real_estate_type',array('0'=>'Rent','1'=>'Sale'),array('class'=>'form-control')); ?>
        </div>
      ...
      <div class="form-group">
        <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="inputEmail3">REAl State Fascilites  :</label>
        <div class="col-md-6 col-sm-8 col-xs-12">
     <?php echo $form->textAreaRow($productdetails, 'real_estate_facilities', array('rows' => 6, 'cols' => 50, 'class' => 'form-control')); ?>
        </div>
      </div>
