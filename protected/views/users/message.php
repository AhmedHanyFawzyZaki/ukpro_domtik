...
<colgroup>
 ...
 $from=User::model()->findByAttributes(array('id'=> $message->sender_id));
        ...
        <tr>
          ...
          <td><?php echo $from->username; ?></td>
          <td><?php  echo $message->message_date;?></td>
          <td class="last"><a href="<?php echo Yii::app()->request->baseUrl; ?>/users/deletemessage/<?php echo  $message->id; ?>" onclick="return confirm('Do you want delete this message : <?=$message->title?>?')"><i class="fa fa-trash-o"></i></a></td>
