...
YII::app()->clientScript->registerScript('gg', '
    $("#prog").animate({width : 400},10000,"linear",function(){
        window.location = "' . Yii::app()->createUrl('travel/flight_hotel', array('flight_search_id' => $flight_search_id, 'hotel_search_id' => $hotel_search_id, 'trip_id' => $trip_id, 'currency' => $currency)) . '";
    });
');
?>
