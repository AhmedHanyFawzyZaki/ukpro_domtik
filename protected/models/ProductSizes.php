...
class ProductSizes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('product_id, sizes_id', 'required'),
			array('product_id, sizes_id, sort', 'numerical', 'integerOnly'=>true),
			array('temp1, temp2', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, product_id, sizes_id, sort, temp1, temp2', 'safe', 'on'=>'search'),
		);
	}
