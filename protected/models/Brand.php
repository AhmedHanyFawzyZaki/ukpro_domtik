...
class Brand extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('title, image, description, temp2', 'length', 'max' => 255),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, title, image, description, sort, temp2', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'productDetails' => array(self::HAS_MANY, 'ProductDetails', 'brand_id'),
