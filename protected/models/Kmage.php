...
/**
 * This is the model class for table "kmage".
 *
 * The followings are the available columns in table 'kmage':
 * @property integer $id
 ...
 */
class Kmage extends CActiveRecord {
     ...
     * @return Kmage the static model class
     */
