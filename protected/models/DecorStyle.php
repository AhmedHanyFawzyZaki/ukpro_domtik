...
/**
 * This is the model class for table "decor_style".
 *
 * The followings are the available columns in table 'decor_style':
 * @property integer $id
 ...
 */
class DecorStyle extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'productDetails' => array(self::HAS_MANY, 'ProductDetails', 'decor_style_id'),
        );
    }
     ...
     * @return DecorStyle the static model class
     */
