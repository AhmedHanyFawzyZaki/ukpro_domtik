...
?>
<div class="GalleryEditor<?php echo $cls?>" id="<?php echo $this->id?>"   style="width:780px;"  >
    <div class="gform"  style="width:750px;"   >
    ...
    <hr/>
    <div class="sorter"   style="width:800px;" >
        <div class="images">
    ...
    <div class="modal  editor-modal" style="display:none;width: 900px;min-height:100px;"  aria-hidden="true"> <!-- fade removed because of opera -->
        ...
        <div class="modal-body">
            ...
            <a href="#" class="btn btn-danger" data-dismiss="modal"><?php echo Yii::t('galleryManager.main', 'Close')?></a>
        </div>
        </div>
