...
<<<<<<< HEAD
	you.html("<textarea clas='form-control you-textarea' rows='5'></textarea><div class='exceded'></div><br/>");	
=======
	you.html("<textarea clas='form-control'></textarea><div class='exceded'></div><br/>");	
>>>>>>> 9bff68c04fc6606668d537da72ef6b1b89deb065
	you.append("<button class='btn btn-default register-bt'>"+options.sendButtonText+"</button>");
	posts.html("");
